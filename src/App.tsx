...
import { raidMembers, raidMemberMap } from "./components/raids";
import { GuidePage } from "./components/GuidePage";
import { HomePage } from "./components/HomePage";
import { MyPage } from "./components/MyPage";
import { SimulationPage } from "./components/SimulationPage";
import { RaidGuidePage } from "./components/RaidGuidePage";
...
export default function App() {
  return (
    <Routes>
      <Route path="/" element={<HomePage healers={healers} simulators={simulators} raidMembers={raidMembers} />} />
      <Route path="/my" element={<MyPage />} />
      <Route path="/guide/:slug" element={<GuidePage healerMap={healerMap} />} />
      <Route path="/raid/:slug" element={<RaidGuidePage raidMemberMap={raidMemberMap} />} />
